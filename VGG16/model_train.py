...
def train_val_data_process():
    ...
    train_dataloader = DataLoader(train_data, batch_size=12, shuffle=True,num_workers=0)
    val_dataloader = DataLoader(val_data, batch_size=12, shuffle=True,num_workers=0)
...
if __name__ == '__main__':
    ...
    train_process = train_model_process(VGG16,train_dataloader,train_dataloader,num_epochs=100)
